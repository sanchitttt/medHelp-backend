...
async function sendEmail(email, link, type = "VERIFY") {
    ...
    const info = await transporter.sendMail({
        ...
        <body>
          ...
          <b><a href=${process.env.ENV === 'development' ? 'http://localhost:8082/auth/signupusers/' : 'https://med-help-backend.vercel.app/auth/signupusers' + link}>Verification link</a></b>
